  ...
  return (
    <div className="legalContent">
      ...
      <ul>
        ...
        <li>
          RAJEEV RANJAN PRADHAN does not accept cancellation requests for perishable items like flowers,
        ...
        <li>
          ...
          the issue to them. In case of any Refunds approved by the RAJEEV RANJAN PRADHAN, it’ll take 3-5
