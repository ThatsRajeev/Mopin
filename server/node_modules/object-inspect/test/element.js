...
test('element', function (t) {
    ...
    var obj = [1, elem, 3];
    t.deepEqual(inspect(obj), '[ 1, <div className="row"></div>, 3 ]');
    t.deepEqual(inspect(obj, { quoteStyle: 'single' }), "[ 1, <div className='row'></div>, 3 ]");
    t.deepEqual(inspect(obj, { quoteStyle: 'double' }), '[ 1, <div className="row"></div>, 3 ]');
});
